...
public protocol Expression : BidirectionalCollection where Element == SymbolProtocol/*, Indices : BidirectionalCollection*/ {   // TODO: Add constraint when compiler crasher is fixed.
