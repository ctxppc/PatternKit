...
public protocol Pattern {
	...
	associatedtype ForwardMatchCollection : BidirectionalCollection where
		ForwardMatchCollection.Element == Match<Subject>,
		ForwardMatchCollection.Indices : BidirectionalCollection,
		ForwardMatchCollection.SubSequence : BidirectionalCollection,
		ForwardMatchCollection.SubSequence.Indices : BidirectionalCollection	// TODO: Remove BidirectionalCollection constraints when recursive conformances land in Swift.
	
	/// The type for collections of matches generated by patterns during backward matching.
	associatedtype BackwardMatchCollection : BidirectionalCollection where
		BackwardMatchCollection.Element == Match<Subject>,
		BackwardMatchCollection.Indices : BidirectionalCollection,
		BackwardMatchCollection.SubSequence : BidirectionalCollection,
		BackwardMatchCollection.SubSequence.Indices : BidirectionalCollection	// TODO: Remove BidirectionalCollection constraints when recursive conformances land in Swift.
